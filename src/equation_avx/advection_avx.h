...
namespace PANSLBM2 {
    namespace AD {
        ...
        template<class Q>
        void Macro(__m256d &__tem, __m256d &__qx, __m256d &__qy, const __m256d &__ux, const __m256d &__uy, const __m256d *__g, const __m256d &__omegag) {
            __tem = __g[0];
        ...
        template<class Q>
        void Macro(__m256d &__tem, __m256d &__qx, __m256d &__qy, __m256d &__qz, const __m256d &__ux, const __m256d &__uy, const __m256d &__uz, const __m256d *__g, const __m256d &__omegag) {
            __tem = __g[0];
            __qx = _mm256_setzero_pd();
            __qy = _mm256_setzero_pd();
        ...
        template<class Q>
        void Equilibrium(__m256d *__geq, const __m256d &__tem, const __m256d &__ux, const __m256d &__uy) {
            for (int c = 0; c < Q::nc; ++c) {
                __m256d __cu = _mm256_add_pd(_mm256_mul_pd(Q::__cx[c], __ux), _mm256_mul_pd(Q::__cy[c], __uy));
                __geq[c] = _mm256_mul_pd(Q::__ei[c], _mm256_mul_pd(__tem, _mm256_add_pd(_mm256_set1_pd(1.0), _mm256_mul_pd(_mm256_set1_pd(3.0), __cu))));
            }
        }

        //  Function of getting equilibrium of AD for 3D
        template<class Q>
        void Equilibrium(__m256d *__geq, const __m256d &__tem, const __m256d &__ux, const __m256d &__uy, const __m256d &__uz) {
            for (int c = 0; c < Q::nc; ++c) {
                __m256d __cu = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(Q::__cx[c], __ux), _mm256_mul_pd(Q::__cy[c], __uy)), _mm256_mul_pd(Q::__cz[c], __uz));
                __geq[c] = _mm256_mul_pd(Q::__ei[c], _mm256_mul_pd(__tem, _mm256_add_pd(_mm256_set1_pd(1.0), _mm256_mul_pd(_mm256_set1_pd(3.0), __cu))));
            }
        }
        ...
        template<class Q>
        void ExternalForceHeatExchange(const __m256d &__tem, const __m256d &__beta, __m256d *__g) {
        ...
        void MacroCollideForceConvection(
            ...
            for (int pidx = 0; pidx < ne; ++pidx) {
                ...
                //  Collide
                NS::Equilibrium<P<double> >(__feq, __rho, __ux, __uy, __uz);
                for (int c = 0; c < P<double>::nc; ++c) {
                    __f[c] = _mm256_add_pd(_mm256_mul_pd(__iomegaf, __f[c]), _mm256_mul_pd(__omegaf, __feq[c]));
                }
                _p.StoreF(idx, __f);
                Equilibrium<Q<double> >(__geq, __tem, __ux, __uy, __uz);
                for (int c = 0; c < Q<double>::nc; ++c) {
                    __g[c] = _mm256_add_pd(_mm256_mul_pd(__iomegag, __g[c]), _mm256_mul_pd(__omegag, __geq[c]));
                }
                _q.StoreF(idx, __g);
        ...
        //  Function of Update macro and Collide of natural convection with Level-Set-Method for 2D
        template<template<class>class P, template<class>class Q>
        void MacroCollideNaturalConvectionLSM(
            P<double>& _p, double *_rho, double *_ux, double *_uy, const double *_chi, double _viscosity,
            Q<double>& _q, double *_tem, double *_qx, double *_qy, const double *_diffusivity, 
            double _gx, double _gy, double _tem0, bool _issave = false, double *_g = nullptr
        ) {
            const int ne = _p.nxyz/P<double>::packsize;
            ...
            for (int pidx = 0; pidx < ne; ++pidx) {
                ...
                NS::Equilibrium<P<double> >(__feq, __rho, _mm256_mul_pd(__ux, __chi), _mm256_mul_pd(__uy, __chi));
                for (int c = 0; c < P<double>::nc; ++c) {
                    __f[c] = _mm256_add_pd(_mm256_mul_pd(__iomegaf, __f[c]), _mm256_mul_pd(__omegaf, __feq[c]));
                }
                _p.StoreF(idx, __f);
                Equilibrium<Q<double> >(__geq, __tem, _mm256_mul_pd(__ux, __chi), _mm256_mul_pd(__uy, __chi));
                for (int c = 0; c < Q<double>::nc; ++c) {
                    __g[c] = _mm256_add_pd(_mm256_mul_pd(__iomegag, __g[c]), _mm256_mul_pd(__omegag, __geq[c]));
                }
                _q.StoreF(idx, __g);
            ...
            for (int idx = ne*P<double>::packsize; idx < _p.nxyz; ++idx) {
                ...
                //  Collide
                NS::Equilibrium<double, P>(feq, rho, ux*_chi[idx], uy*_chi[idx]);
                _p.f0[idx] = iomegaf*_p.f0[idx] + omegaf*feq[0];
                for (int c = 1; c < P<double>::nc; ++c) {
                    int idxf = P<double>::IndexF(idx, c);
                    _p.f[idxf] = iomegaf*_p.f[idxf] + omegaf*feq[c];
                }
                Equilibrium<double, Q>(geq, tem, ux*_chi[idx], uy*_chi[idx]);
                _q.f0[idx] = iomegag*_q.f0[idx] + omegag*geq[0];
                for (int c = 1; c < Q<double>::nc; ++c) {
                    int idxf = Q<double>::IndexF(idx, c); 
                    _q.f[idxf] = iomegag*_q.f[idxf] + omegag*geq[c];
        ...
        //  Function of Update macro and Collide of natural convection with Level-Set-Method for 3D
        template<template<class>class P, template<class>class Q>
        void MacroCollideNaturalConvectionLSM(
            P<double>& _p, double *_rho, double *_ux, double *_uy, double *_uz, const double *_chi, double _viscosity,
            Q<double>& _q, double *_tem, double *_qx, double *_qy, double *_qz, const double *_diffusivity, 
            double _gx, double _gy, double _gz, double _tem0, bool _issave = false, double *_g = nullptr
        ) {
            const int ne = _p.nxyz/P<double>::packsize;
            ...
            for (int pidx = 0; pidx < ne; ++pidx) {
                ...
                //  Collide
                __m256d __chi = _mm256_loadu_pd(&_chi[idx]);
                NS::Equilibrium<P<double> >(__feq, __rho, _mm256_mul_pd(__ux, __chi), _mm256_mul_pd(__uy, __chi), _mm256_mul_pd(__uz, __chi));
                for (int c = 0; c < P<double>::nc; ++c) {
                    __f[c] = _mm256_add_pd(_mm256_mul_pd(__iomegaf, __f[c]), _mm256_mul_pd(__omegaf, __feq[c]));
                }
                _p.StoreF(idx, __f);
                Equilibrium<Q<double> >(__geq, __tem, _mm256_mul_pd(__ux, __chi), _mm256_mul_pd(__uy, __chi), _mm256_mul_pd(__uz, __chi));
                for (int c = 0; c < Q<double>::nc; ++c) {
                    __g[c] = _mm256_add_pd(_mm256_mul_pd(__iomegag, __g[c]), _mm256_mul_pd(__omegag, __geq[c]));
                }
                _q.StoreF(idx, __g);
            ...
            for (int idx = ne*P<double>::packsize; idx < _p.nxyz; ++idx) {
                ...
                //  Collide
                NS::Equilibrium<double, P>(feq, rho, ux*_chi[idx], uy*_chi[idx], uz*_chi[idx]);
                _p.f0[idx] = iomegaf*_p.f0[idx] + omegaf*feq[0];
                for (int c = 1; c < P<double>::nc; ++c) {
                    int idxf = P<double>::IndexF(idx, c);
                    _p.f[idxf] = iomegaf*_p.f[idxf] + omegaf*feq[c];
                }
                Equilibrium<double, Q>(geq, tem, ux*_chi[idx], uy*_chi[idx], uz*_chi[idx]);
                _q.f0[idx] = iomegag*_q.f0[idx] + omegag*geq[0];
                for (int c = 1; c < Q<double>::nc; ++c) {
                    int idxf = Q<double>::IndexF(idx, c); 
                    _q.f[idxf] = iomegag*_q.f[idxf] + omegag*geq[c];
