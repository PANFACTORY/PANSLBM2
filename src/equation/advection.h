...
namespace PANSLBM2 {
    ...
    namespace AD {
        ...
        //  Function of Update macro, Collide and Stream of AD with NS for 3D
        template<class T, class P, class Q>
        void Macro_Collide_Stream_NaturalConvection(
        ...
        //  Function of setting boundary condition set T of AD for 3D
        template<class T, class Q>
        ...
        //  Function of setting boundary condition set q of AD for 2D (diffusivity constant)
        template<class T, class Q>
        ...
        //  Function of setting boundary condition set q of AD for 3D (diffusivity constant)
        template<class T, class Q>
