...
int main() {
    ...
    for (int t = 0; t < tmax; t++) {
        ...
        for (int i = 0; i < nx; i++) {
            particleg.SetTemperature(i, 0, ux[particlef.GetIndex(i, 0)], uy[particlef.GetIndex(i, 0)], Th);
            particleg.SetTemperature(i, ny - 1, ux[particlef.GetIndex(i, ny - 1)], uy[particlef.GetIndex(i, ny - 1)], Tl);
